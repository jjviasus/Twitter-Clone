...
//  TwitterTutorial
//
//  Created by Justin Viasus on 5/7/22.
//
...
class RegistrationController: UIViewController {
    ...
    private var profileImage: UIImage? // optional because it will start off as nil
    ...
    private lazy var emailContainerView: UIView = {
        let view = Utilities().inputContainerView(withImage: #imageLiteral(resourceName: "mail"), textField: emailTextField)
        return view
    }()
...
extension RegistrationController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    // When image has been selected and choose button is clicked
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        guard let profileImage = info[.editedImage] as? UIImage else { return }
        self.profileImage = profileImage
        
        plusPhotoButton.layer.cornerRadius = 128 / 2         // Round the photo
        
        plusPhotoButton.layer.masksToBounds = true
        plusPhotoButton.imageView?.contentMode = .scaleAspectFill // scales the image to fit the frame that it is contained within
        plusPhotoButton.imageView?.clipsToBounds = true // makes sure the image doesn't go outside of the bounds of the frame
        plusPhotoButton.layer.borderColor = UIColor.white.cgColor
        plusPhotoButton.layer.borderWidth = 3
        
        // Update the photo of the plusPhotoButton
